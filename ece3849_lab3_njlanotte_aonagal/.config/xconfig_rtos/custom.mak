...
linker.cmd: package/cfg/rtos_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/rtos_pem4fcfg.cmd\)\"$""\"D:/ECE3849Labs/ece3849_lab2_starter.zip_expanded/ece3849_lab2_starter/.config/xconfig_rtos/\1\""' package/cfg/rtos_pem4f.xdl > $@
